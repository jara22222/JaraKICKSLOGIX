...
const NAV_ITEMS = [
  { icon: LayoutDashboard, label: "Home", path: "/vas" },
  { icon: PackageOpen, label: "Incoming", path: "/vas/incoming" },
  { icon: PackageCheck, label: "Process", path: "/vas/processing" },
  { icon: Activity, label: "Log", path: "/vas/activity" },
];

export default function VASBottomNav() {
