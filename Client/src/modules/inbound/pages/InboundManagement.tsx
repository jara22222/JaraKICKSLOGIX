                ...
                >
                  <div className="flex items-start justify-between gap-2">
                    <div>
                      ...
                      <p className="text-[10px] font-mono text-slate-400">{shipment.poRef}</p>
                    </div>
                    <span
                      className={`inline-flex items-center gap-1.5 rounded-full border px-2.5 py-1 text-[11px] font-semibold ${getInboundStatusBadgeClass(
                        shipment.status,
                      )}`}
                    >
                  ...
                  <p className="mt-2 text-sm font-medium text-slate-700">{shipment.product}</p>
                  <p className="text-xs text-slate-500">{shipment.supplier}</p>
                  <div className="mt-3 grid grid-cols-2 gap-2 text-xs">
                    <div className="rounded-lg border border-slate-100 bg-slate-50 px-2 py-1.5">
                      <p className="text-slate-400">SKU</p>
                      <p className="font-mono font-bold text-[#001F3F]">{shipment.sku}</p>
                    </div>
                    <div className="rounded-lg border border-slate-100 bg-slate-50 px-2 py-1.5">
                      <p className="text-slate-400">Quantity</p>
                      <p className="font-bold text-[#001F3F]">{shipment.qty.toLocaleString()}</p>
                    </div>
                  </div>
                  <p className="mt-2 text-xs text-slate-500">ETA: {shipment.eta}</p>
                  <button
                    onClick={() =>
                      setApproveTarget({
                        id: shipment.id,
                    ...
                    className="mt-3 w-full px-3 py-2 bg-emerald-600 text-white text-xs font-bold uppercase tracking-wider rounded-lg inline-flex items-center justify-center gap-1.5 disabled:opacity-60"
                  >
